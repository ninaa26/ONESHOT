...
Working documents about the simulator. Recovered from published Artifacts on
2026-09-21 — none of them had a copy on this machine before that.
...
`claude.ai/artifact/7FbCn1n5z6VoLDBt58XUV1`. It is a Claude Doc rather than a
plain page; read it at that link.

These live in ONESHOT because it is your own repository. If you open a pull
request against `CUSail-Navigation/sailbench`, exclude `docs/` — these are
your notes, not team files.
