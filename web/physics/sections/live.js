 ...
 * (see `web/shared/sim-app.js`), mirrors the running boat, and cross-checks the forces
...
/** Same URL rule as web/shared/sim-app.js so both views follow the same backend. */
function wsUrl() {
  ...
  function connect() {
    ...
    socket.onmessage = (ev) => {
      try {
        ...
        // ignore malformed frames, same as web/shared/sim-app.js
      }
    };
