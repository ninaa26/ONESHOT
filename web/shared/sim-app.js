...
export function createSimApp({ createShipyard }) {
  ...
  // The radar is optional chrome: an app whose page carries no `#radar` canvas
  // gets a radar that does nothing, rather than the sim failing to start.
  ...
  // command and then both are made to agree with it. A page without the sliders
  // (the game, the physics lab) still gets the keys.
